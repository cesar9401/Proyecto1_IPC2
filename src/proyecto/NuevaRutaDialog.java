...
public class NuevaRutaDialog extends java.awt.Dialog {
    ...
    public NuevaRutaDialog(java.awt.Frame parent, Sistema sistema) {
        ...
        sistema.setContadorRutas(sistema.getContadorRutas());
    ...
    private void initComponents() {
        ...
        scroll1.setViewportView(tablaPuntosRuta);
        ...
        bindingGroup.addBinding(jTableBinding);
        jTableBinding.bind();
        scroll2.setViewportView(jTable2);
        ...
        panelNuevaRutaLayout.setHorizontalGroup(
            ...
            .addGroup(panelNuevaRutaLayout.createSequentialGroup()
                .addGroup(panelNuevaRutaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelNuevaRutaLayout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(scroll1, javax.swing.GroupLayout.DEFAULT_SIZE, 583, Short.MAX_VALUE))
                    .addGroup(panelNuevaRutaLayout.createSequentialGroup()
                        .addContainerGap()
        ...
        panelNuevaRutaLayout.setVerticalGroup(
            ...
            .addGroup(panelNuevaRutaLayout.createSequentialGroup()
                ...
                .addComponent(AgregarPuntoBoton)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(scroll2, javax.swing.GroupLayout.PREFERRED_SIZE, 77, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panelNuevaRutaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(AceparBoton)
                    .addComponent(cancelarRuta))
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(panelNuevaRuta, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
    ...
    private void codigoDTKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_codigoDTKeyReleased
        if(!codigoDT.getText().equals("")){
            for (int i=0; i<sistema.getRutas().size(); i++) {
                if(codigoDT.getText().equalsIgnoreCase(sistema.getRutas().get(i).getCod_D())){
                    codigoDT.setText(sistema.getRutas().get(i).getCod_D());
                    paisText.setText(sistema.getRutas().get(i).getPais());
                    nombreCiudadT.setText(sistema.getRutas().get(i).getCiudad());
                    precioText.setText("" + sistema.getRutas().get(i).getPrecio());
                    precio = sistema.getRutas().get(i).getPrecio();
                    
                    paisText.setEditable(false);
                    nombreCiudadT.setEditable(false);
                    precioText.setEditable(false);
                    
                    break;
                }else{
                    paisText.setText(null);
                    nombreCiudadT.setText(null);
                    precioText.setText(null);
                    precio = 0;

                    paisText.setEditable(true);
                    nombreCiudadT.setEditable(true);
                    precioText.setEditable(true);
                }
            }
        }
    }//GEN-LAST:event_codigoDTKeyReleased
